...
export default {
  methods: {
    view: function () {
      ...
      if (this.select === '1') {
        ...
        const _this = this
        axios.get('http://localhost:10010/reports/reports/booking-by-offices', {params: {'officeUid': officeUid}}).then(function (resp) {
        ...
        const _this = this
        axios.get('http://localhost:10010/reports/reports/booking-by-models/', {params: {'model': model}}).then(function (resp) {
          _this.tableData = resp.data
          console.log(resp)
        })
      }
    ...
    del(row) {
      const _this = this
      axios.delete('http://localhost:10010/office/offices/' + this.$route.query.officeUid + '/car/' + row.availableCars.car.carUid).then(function (resp) {
        console.log(resp)
        if (resp.status === 204) {
  ...
  //     //GET /reports/booking-by-offices
  //     const _this = this
  //     axios.get('http://192.168.3.131:10010/reports/reports/booking-by-offices' + this.tableData.input3).then(function (resp) {
  //       _this.tableData = resp.data
  //       console.log(resp)
  //     })
  //   } else if(this.select === 2) {
  ...
  //     // GET / offices / {officeUid} / cars / {carUid}
  //     const _this = this
  //     axios.get('http://192.168.3.131:10010/reports/reports/booking-by-models' + this.tableData.input3).then(function (resp) {
  //       _this.tableData = resp.data
  //       console.log(resp)
  //     })
  //   }
